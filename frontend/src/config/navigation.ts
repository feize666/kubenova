...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: "configs-limitranges",
        path: "/configs/limitranges",
        label: "LimitRange（资源限制范围）",
        canonicalNameEn: "LimitRange",
        canonicalNameZh: "资源限制范围",
        description: "管理命名空间内资源默认值、最小值与最大值约束。",
        domain: "configs",
        requiredRole: "admin",
      },
      {
        key: "configs-resourcequotas",
        path: "/configs/resourcequotas",
        label: "ResourceQuota（资源配额）",
        canonicalNameEn: "ResourceQuota",
        canonicalNameZh: "资源配额",
        description: "管理命名空间资源用量配额与硬限制。",
        domain: "configs",
        requiredRole: "admin",
      },
    ],
